 ...
 * @param db An uninitialised database
 * @author Aryan Jassal
 */
 ...
 * @param key
 * @param value
 * @param kek The encryption key is needed to rotate the AES IV after changes
 * @author Aryan Jassal
 */
 ...
 * bin from disk, but only free up the resources consumed by an open bin.
 * @param db An uninitialised database
 * @author Aryan Jassal
 */
